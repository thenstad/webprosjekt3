...
var SERVERROOT = 'http://localhost:8983/solr/wp3/select?'; //SELECT endpoint
...
var FACETS = ['id','attr_pdf_docinfo_created'];                       //facet categories

var FACETS_TITLES = {'id': 'id'};  // selective rename facet names for display
